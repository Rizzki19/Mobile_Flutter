      ...
      builder: (_) => AlertDialog(
        ...
        content: SingleChildScrollView(
          child: Column(
            ...
            children: const [
              Text(
                '1. Menu Deteksi ini tidak memutuskan apakah anda terkena stroke atau tidak, namun memberikan deteksi dini apakah anda beresiko atau tidak berdasarkan data yang Anda masukkan.',
                style: TextStyle(fontSize: 16, height: 1.5),
              ),
              Text(
                '2. Diperlukan sebuah pemeriksaan lebih lanjut untuk memastikan apakah Anda benar-benar terkena stroke atau tidak.',
                style: TextStyle(fontSize: 16, height: 1.5),
              ),
              SizedBox(height: 8),
              Text(
                '3. Pastikan data yang Anda masukkan sudah benar dan sesuai dengan kondisi Anda saat ini. Beberapa variabel data masih perlu diperiksa di puskesmas atau rumah sakit, seperti memiliki hipertensi atau tidak dan kadar gula darah.',
                style: TextStyle(fontSize: 16, height: 1.5),
              ),
              Text(
                '4. Untuk Pilihan Hipertensi, Pastikan anda sudah melakukan pemeriksaan tekanan darah sebelumnya ke puskesmas atau rumah sakit, dan memang dipastikan Anda benar memiliki hipertensi. Karena ada beberapa kasus orang yang memiliki tekanan darah tinggi diatas 120/80 namun dinyatakan tidak memiliki hipertensi.',
                style: TextStyle(fontSize: 16, height: 1.5),
              ),
              Text(
                '5. Untuk BMI, anda bisa melakukan pengecekan bimi di website kami kenali pada menu bmi.',
                style: TextStyle(fontSize: 16, height: 1.5),
              ),
              Text(
                '6. Pada pilihan perokok, anda bisa memilih tidak jika dalam jangka waktu 1 bulan terakhir anda tidak merokok, dan memilih iya jika dalam jangka waktu 1 bulan terakhir anda merokok.',
                style: TextStyle(fontSize: 16, height: 1.5),
              ),
              Text(
                '7. Hasil deteksi yang ditampilkan adalah sebuah klasifikasi apakah Anda beresiko terkena stroke atau tidak berdasarkan data yang Anda masukkan. Jika hasilnya beresiko, disarankan untuk melakukan pemeriksaan lebih lanjut ke puskesmas atau rumah sakit.',
                style: TextStyle(fontSize: 16, height: 1.5),
              ),
            ],
          ),
