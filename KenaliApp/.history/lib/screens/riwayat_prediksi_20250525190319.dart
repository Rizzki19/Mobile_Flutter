            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: (data['prediction'] != null && data['prediction'].toString().toLowerCase().contains('beresiko')) 
                  ...
                  child: Row(
                    children: [
                      Icon(
                        data['prediction']?.toString().toLowerCase().contains('beresiko')
                            ? Icons.warning
                            : Icons.check_circle,
                        color: data['prediction']?.toString().toLowerCase().contains('beresiko')
                            ? Colors.red
                            : Colors.green,
                      ),
              ...
              child: Column(
                ...
                children: [
                  Row(
                    children: [
                      Icon(
                        item['prediction']?.toString().toLowerCase().contains('beresiko')
                            ? Icons.warning
                            : Icons.check_circle,
                        color: item['prediction']?.toString().toLowerCase().contains('beresiko')
                            ? Colors.red
                            : Colors.green,
                      ),
