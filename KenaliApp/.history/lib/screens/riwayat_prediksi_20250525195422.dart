...
class _RiwayatPrediksiState extends State<RiwayatPrediksi> {
              ...
              children: [
                ...
                GridView.count(
                  ...
                  children: [
                    ...
                    _buildDetailItem('Jenis Kelamin', _mapGender(data['gender'])),
                    _buildDetailItem('Hipertensi', _mapBool(data['hypertension'])),
                    _buildDetailItem('Penyakit Jantung', _mapBool(data['heart_disease'])),
                    _buildDetailItem('Status Menikah', _mapBool(data['ever_married'])),
                    _buildDetailItem('Pekerjaan', _mapWorkType(data['work_type'])),
                    _buildDetailItem('Tinggal', _mapResidence(data['Residence_type'])),
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: const [
          BottomNavigationBarItem(
              icon: Icon(Icons.history), label: 'Dashboard'),
  ...
  // Mapping gender value to readable string
  ...
  // Mapping boolean-like values to readable string (for hypertension, heart disease, ever married)
  ...
  // Mapping work type to readable string
  String _mapWorkType(dynamic workType) {
    ...
    switch (workType.toString().toLowerCase()) {
      ...
      case 'govt_job':
        return 'PNS';
      case 'never_worked':
        return 'Belum Pernah Bekerja';
      default:
        return workType.toString();
    }
  }

  // Mapping residence type to readable string
