...
class _MenuPrediksiState extends State<MenuPrediksi> {
  ...
  Future<void> _validateAndConfirm() async {
    ...
    if ([usia, bmi, gula].contains('') ||
        !_isNumberValid(usia) ||
        !_isNumberValid(bmi) ||
        !_isNumberValid(gula) ||
        [genderValue, hipertensiValue, jantungValue, menikahValue, pekerjaanValue, areaValue, rokokValue]
            .any((v) => v.trim().isEmpty)) {
      _showSnackBar('Mohon lengkapi semua data dengan benar!');
      return;
    }
        ...
        actions: [
          ...
          ElevatedButton(
            style: ElevatedButton.styleFrom(
              backgroundColor: Color(0xFF6DE39D),
            ),
            ...
            children: [
              ...
              Center(
                child: ElevatedButton.icon(
                  ...
                  label: Text(isLoading ? 'Memproses...' : 'Deteksi Sekarang'),
                ),
              ),
            ],
          ),
