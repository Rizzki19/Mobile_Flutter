    ...
    builder: (BuildContext context) {
      ...
      return AlertDialog(
        ...
        content: SingleChildScrollView(
          child: ListBody(
            children: <Widget>[
              Text("Hasil Deteksi: ${data['hasil']}", style: TextStyle(fontWeight: FontWeight.w600)),
              Divider(),
              Text("Tanggal: ${data['created_at']}"),
              Text("Usia: ${data['age']} tahun"),
              Text("Jenis Kelamin: ${convert(data['gender'], (v) => v == '1' ? 'Laki-laki' : 'Perempuan')}"),
              Text("Hipertensi: ${convert(data['hypertension'], (v) => v == 1 ? 'Ya' : 'Tidak')}"),
              Text("Penyakit Jantung: ${convert(data['heart_disease'], (v) => v == 1 ? 'Ya' : 'Tidak')}"),
              Text("Status Menikah: ${convert(data['ever_married'], (v) => v)}"),
