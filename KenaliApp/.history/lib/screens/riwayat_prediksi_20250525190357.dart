          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                // Hasil Deteksi dengan card khusus
                // Assign prediction to a variable and check for null before using as a condition
                Builder(
                  builder: (context) {
                    final predictionStr = data['prediction']?.toString().toLowerCase();
                    final isBeresiko = predictionStr != null && predictionStr.contains('beresiko');
                    return Container(
                      ...
                      child: Row(
                        children: [
                          Icon(
                            isBeresiko ? Icons.warning : Icons.check_circle,
                            color: isBeresiko ? Colors.red : Colors.green,
                          ),
                          const SizedBox(width: 10),
                          Expanded(
                            child: Text(
                              'Hasil Deteksi: ${data['prediction'] ?? 'Tidak ada hasil'}',
                              style: TextStyle(
                                fontWeight: FontWeight.bold,
                                color: isBeresiko ? Colors.red : Colors.green,
                              ),
            ...
            child: Padding(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                  Builder(
                    builder: (context) {
                      final predictionStr = item['prediction']?.toString().toLowerCase();
                      final isBeresiko = predictionStr != null && predictionStr.contains('beresiko');
                      return Row(
                        children: [
                          Icon(
